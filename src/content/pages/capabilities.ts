...
export const CAPABILITIES_PAGE: PageContent = {
  title: "Capabilities",
  intro: [
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "We advise on company formation, group restructuring, shareholder arrangements, joint ventures, and ongoing corporate governance.",
        "Our commercial contracting practice supports vendor, distribution, services, and partnership arrangements aligned to operational realities and risk tolerance.",
      ],
    },
    {
    ...
    },
    {
      ...
      eyebrow: "Capability",
      imageKey: "child",
      title: "Private Wealth and Family Office",
      body: [
        "We advise founders, families, and family offices on succession planning, trusts, holding structures, and intergenerational wealth transfer.",
        "Our private wealth team works alongside corporate and tax colleagues to deliver coordinated advice on personal and business interests.",
      ],
    },
  ],
};
