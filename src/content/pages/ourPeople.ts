...
export const OUR_PEOPLE_PAGE: PageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Structured engagements, clear deliverables",
      body: [
        "We set scope, timing, and deliverables at the start of an engagement and keep communication consistent throughout the matter.",
        "Clients receive clear action items, defined responsibilities, and a structured path to completion across each stage of work.",
      ],
    },
    {
